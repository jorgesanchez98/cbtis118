...
function disconnect($con) {
    ...
    function login($user, $pass) {
        ...
        if ($db != NULL) {
            ...
            $stm=$db->prepare("SELECT * FROM usuario WHERE Id_Usuario=:idUser AND Contrasena=:pass");
    ...
    function sidebarFunc($rol)
    {
	    if($rol==="Cliente")
	    {
		    $nav = array("Cuenta","Información personal","Transacciones Realizadas","Nueva Transacción");
	    }
	    if($rol==="Empleado")
	    {
		    $nav = array("Área de trabajo","Información personal","Cuenta","Transacciones realizadas","Nueva Transacción");
	    }
 	    if($rol==="Administrador")
	    {
		    $nav = array("Usuarios Registrados","Personal Habilitado","Transacciones Realizadas","Sub-consultas");
	    }
	    $ret = "";
	    $nav[] = "Salir";
	    foreach ($nav as $module)
	    {
		    ...
		    $ret.= '<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link" href="index.php?module='.$module.'"><i class="fas fa-file-alt"></i>'.$module.'</a></li>
					</ul>';
	    } 
	    return $ret;
    }
